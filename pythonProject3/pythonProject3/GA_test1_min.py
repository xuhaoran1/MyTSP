...
if __name__ == '__main__':
    ...
    for j in range(10000):
        ...
        # 画图
    plot_curve_travel_route(min_path, "The_shortest_path")
    plot_curve_errorbar(final_final_min, final_final_min_flag, "The_shortest_path_errorbar")
    a = pd.DataFrame(final_final_min, columns=['min_result'])
    a['min_flag'] = final_final_min_flag
    a.to_excel("GA_1_min.xlsx")
