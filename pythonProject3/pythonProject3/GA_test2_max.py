...
if __name__ == '__main__':
    ...
    # 画图
    plot_curve_travel_route(max_path, "GA_1_The_longest_path")
    plot_curve_errorbar(final_final_max, final_final_max_flag, "GA_1_The_longest_path_errorbar")
    a = pd.DataFrame(final_final_max, columns=['max_result'])
    a['max_flag'] = final_final_max_flag
    a.to_excel("GA_2_max.xlsx")